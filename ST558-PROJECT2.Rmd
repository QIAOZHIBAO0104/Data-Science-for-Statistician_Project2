...
rmarkdown::render("ST558 PROJECT2.Rmd", output_file= "README.md")
```
# Introduction  
## Describe the data  
...
pred <- predict(tree.method,test_data)
treeRMSE <- sqrt(mean((pred- test_data$shares)^2))
treeRMSE
postResample(pred,test_data$shares)
```
# Second Model
...
```{r}
pred <- predict(boosted.method,test_data)
